...
# Stability caps (keeps scores from going crazy)
RS_CAP = 0.10   # +/-10% relative strength cap
ROT_CAP = 0.08  # +/-8% rotation cap
...
def clamp_rs(x: float, lo: float, hi: float) -> float:
